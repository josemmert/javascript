...
//     }
//     mostrarInformacion(){
//         console.log(`Hola mi nombre es ${this.name}, mi apellido es ${this.surName} y mi edad es ${this.age}, mi rol es: ${this.rol} y estoy en el curso de ${this.curso}`);
//     }
// }

// const alumno=new Alumno('Jose','Emmert', 30, 'alumno', 'FullStack');
...
//     mostrarInformacion(){
//         console.log(`Hola mi nombre es ${this.name}, mi apellido es ${this.surName} y mi edad es ${this.age}, mi rol es: ${this.rol} y dicto el curso de ${this.materia}`);
//     }
// }
